...
export namespace Gana {
    ...
    export const katakana = [
        ...
        'ヮ', 'ワ', 'ヰ', 'ヱ', 'ヲ', 'ン',
        // 기타
        'ヴ', 'ヵ', 'ヶ', 'ー' // 'ー' (長音記号)는 카타카나에서 사용되므로 끝에 추가
    ];

    export const halfwidthKatakana = [
        // 반각은 U+FF6x 계열; 다쿠텐/한다쿠텐은 별도 문자(ﾞ U+FF9E, ﾟ U+FF9F)와 조합됨.
        // 여기에선 읽기 편하게 "조합된 문자열"로 표기합니다.
        'ｧ', 'ｱ', 'ｨ', 'ｲ', 'ｩ', 'ｳ', 'ｪ', 'ｴ', 'ｫ', 'ｵ',
